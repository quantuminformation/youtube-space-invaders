// var GAME_SPEED: number = 50 // the higher the number the faster the game will run, all movements are effected by this number
// export const GAME_SPEED: number = 500
// export { GAME_SPEED }
